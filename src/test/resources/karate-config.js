function fn() {
    ...
    config.adminUri = config.rootUrl + 'api/admin/';
        ...
        config.tauxTaxeSejourAnnuelUrl = config.adminUri + 'tauxTaxeSejourAnnuel/';
    config.taxeSejourAnnuelUrl = config.adminUri + 'taxeSejourAnnuel/';
    config.tauxTaxeSejourTrimUrl = config.adminUri + 'tauxTaxeSejourTrim/';
    config.taxeSejourAnnuelDetailUrl = config.adminUri + 'taxeSejourAnnuelDetail/';
    config.taxeSejourTrimUrl = config.adminUri + 'taxeSejourTrim/';

...
import ma.zs.sejour.zynerator.security.bean.*;
import ma.zs.sejour.zynerator.security.common.AuthoritiesConstants;
import ma.zs.sejour.zynerator.security.service.facade.*;


import ma.zs.sejour.zynerator.security.bean.User;
...
public class SejourApplication {
    ...
    public static void main(String[] args) {
        ctx=SpringApplication.run(SejourApplication.class, args);
    }
    ...
    private static void addPermissionForAdmin(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("TauxTaxeSejourAnnuel"));
        modelPermissions.add(new ModelPermission("TaxeSejourAnnuel"));
        modelPermissions.add(new ModelPermission("TauxTaxeSejourTrim"));
        modelPermissions.add(new ModelPermission("TaxeSejourAnnuelDetail"));
        modelPermissions.add(new ModelPermission("TaxeSejourTrim"));

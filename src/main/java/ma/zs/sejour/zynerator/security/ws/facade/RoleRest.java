...
import ma.zs.sejour.zynerator.security.ws.converter.RoleConverter;
import ma.zs.sejour.zynerator.security.ws.dto.RoleDto;
...
public class RoleRest  extends AbstractController<Role, RoleDto, RoleCriteria, RoleService, RoleConverter> {
    ...
    @PostMapping("")
    public int save(@RequestBody RoleDto dto) throws Exception {
